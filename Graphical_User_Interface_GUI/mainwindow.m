...
%MAINWINDOW MATLAB code file for mainwindow.fig
...
% --- Executes during object creation, after setting all properties.
function img_logoKhoa_CreateFcn(hObject, eventdata, handles)
% hObject    handle to img_logoKhoa (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
imshow('C:\Users\20151\Desktop\Robotics\Final_Project\Final_Robotics\Overview\logoKhoa.jpg');
% Hint: place code in OpeningFcn to populate img_logoKhoa


% --- Executes during object creation, after setting all properties.
function img_logoTruong_CreateFcn(hObject, eventdata, handles)
% hObject    handle to img_logoTruong (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
