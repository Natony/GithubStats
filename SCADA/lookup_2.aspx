<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookup_2.aspx.cs" Inherits="lookup_2" %>
...
<head runat="server">
    <title>Tra Cứu Dữ Liệu - SCADA</title>
                ...
                <ContentTemplate>
                    <div id="pannel">
                        <table>
                            ...
                            <tr id="block_UpdatePanel1">
                                <td>
                                    <asp:TextBox ID="tbxName" runat="server"></asp:TextBox></td>
                                <td>
                                    <asp:TextBox ID="tbxStartValue" runat="server"></asp:TextBox></td>
                                <td>
                                    <asp:TextBox ID="tbxEndValue" runat="server"></asp:TextBox></td>
                                <td>
                                    <asp:TextBox ID="tbxStartTime" runat="server"></asp:TextBox></td>
                                <td>
                                    <asp:TextBox ID="tbxEndTime" runat="server"></asp:TextBox></td>
                                <td>
                                    <asp:Button ID="btnXem" runat="server" Text="Xem giá trị" OnClick="BtnXem_Click" />
                                </td>
                            </tr>
                        </table>
                    </div>
